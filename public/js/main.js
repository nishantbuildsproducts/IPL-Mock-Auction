$(function($) {
  ...
  function addParticpantBidders (data) {
    ...
    $('.messages').append('<li class="message show" style="display: list-item;"><span style="color: #000;">Current Bidding @ </span><span class="messageBody">999</span></li>');
  }
...
//console.log('press')
      ...
      {
          // user presses the "0"
          case 48:  bid(999); updateBidding(); disableInitBidAmt(999);
          break;

          // user presses the "1"
          case 49:  bid(1000); updateBidding(); disableInitBidAmt(1000);
          break;
              
          // user presses the "2"
          case 50:  bid(2000); updateBidding(); disableInitBidAmt(2000);
          break;
          
          // user presses the "3"
          case 51:  bid(3000); updateBidding(); disableInitBidAmt(3000);
          break;
          
          // user presses the "4"
          case 52:  bid(4000); updateBidding(); disableInitBidAmt(4000);
          break;
          
          // user presses the "5"
          case 53:  bid(5000); updateBidding(); disableInitBidAmt(5000); 
          break;
      }
      });
  ...
  socket.on('login', function (data) {
    ...
    var message = "Welcome to Gartner Cricket Club IPL Auction 2020 ";
    log(message, {
      prepend: true
    }); 
